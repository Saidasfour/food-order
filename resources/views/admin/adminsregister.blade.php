   ...
   <div class="container">
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <h2 class="text-center text-dark mt-5">Admin Register Form</h2>
          <div class="card my-5">
  
            <form action="/admin/register/auth" method="POST" class="card-body cardbody-color p-lg-5">
              @csrf
              ...
              <div class="mb-3">
                <input name="username" type="text" class="form-control" id="Username" aria-describedby=""
              ...
              <div class="mb-3">
                <input name="password_confirmation" type="password" class="form-control" id="password" placeholder="confirm password" value="{{old('password_confirmation')}}">
              ...
              <div id="emailHelp" class="form-text text-center mb-5 text-dark">Already have an account?
                 <a href="/admins/authenticate" class="text-dark fw-bold"> Login</a>
              </div>
            </form>
          </div>
